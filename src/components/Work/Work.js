...
const heading = ["Work."]
const subheading = "Here's some projects I've worked on."
                                ...
                                <div className="card-inner tag">
                                    <div className="image-holder">
                                        <figure className="image-fig">
                                            <img src={studentCalendar} alt="Calendar" width="810" height="422" loading="lazy" className="image"/>
                                        </figure>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div href="https://github.com/ai-hackathon-team-23/plot-ai" className="card">
                            <div className="card-wrap tag">
                                ...
                                <div className="card-inner tag">
                                    <div className="image-holder">
                                        <figure className="image-fig">
                                            <img src={plotAIimg} alt="PlotAI" width="1000" height="600" loading="lazy" className="image"/>
                                        </figure>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div href="https://github.com/AndyCChen/Downtown-Delivery" className="card">
                            <div className="card-wrap tag">
                                ...
                                <div className="card-inner tag">
                                    <div className="image-holder">
                                        <figure className="image-fig">
                                            <img src={game} alt="Game" width="800" height="575" className="image"/>
                                        </figure>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div href="https://github.com/optimization-for-data-driven-science/RIFLE" className="card">
                            <div className="card-wrap tag">
                                ...
                                <div className="card-inner tag">
                                    <div className="image-holder">
                                        <figure className="image-fig">
                                            <img src={RIFLE} alt="RIFLE" width="810" height="422" loading="lazy" className="image"/>
                                        </figure>
                                    </div>
                                </div>
                            </div>
